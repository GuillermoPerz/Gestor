...
'''Creamos un mixin. Un mixin es una clase que tiene una o varias definiciones y que pueden heredarlas otras clases.'''
...
class CreateClientWindow(Toplevel, CenterWidgetMixin):
    def __init__(self, parent):
        ...
        self.grab_set() #impide que nos relaccionemos con la ventana ppal
